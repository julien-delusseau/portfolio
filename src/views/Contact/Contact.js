...
export const Contact = () => {
  return (
    <section id="contact">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Contact | Julien Delusseau</title>
        <link rel="canonical" href="https://www.juliendelusseau.fr/contact" />
      </Helmet>
      <h1>
        restons en <span className="yellow">contact</span>
      </h1>

      <p className="contact-subtitle">
        N'hésitez pas à entrer en contact avec moi.
        <br />
        Je suis toujours ouvert pour discuter de nouveaux projets.
      </p>
