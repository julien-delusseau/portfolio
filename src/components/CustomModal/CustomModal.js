...
export const CustomModal = ({modalIsOpen, closeModal, project: {title, image, tags, link, github, description}}) => {
    return (
        <Modal
            isOpen={modalIsOpen}
        ...
        >
            <div className="Modal-anchor">
                <div className="modal-top">
                    <h2>{title}</h2>
                    <button title="Fermer le modal" className="close-modal" onClick={closeModal}><i
